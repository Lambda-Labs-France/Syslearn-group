...
export const metadata = {
  title: "Aéronautique : conseil et ingénierie IT pour systèmes certifiés",
    ...
    <main className="aeronautique-page">
      ...
      <section className="aeronautique-content">
        <div className="aeronautique-content__inner">
          ...
          {/* INTRODUCTION AVEC TEXTE ET LIGNE */}
          ...
          <div className="aeronautique-content__block">
            ...
            <p className="text-justify-hyphens">
              Cette exigence s'inscrit dans une filière parmi les plus stratégiques de l'industrie française. En 2025, l'aérospatiale française a réalisé un chiffre d'affaires de <strong>85,6 milliards d'euros</strong>, en hausse de <strong>12 %</strong> sur un an, portée par la reprise du trafic aérien, des exportations solides et une montée en cadence industrielle continue. Le secteur emploie désormais <strong>230 500 salariés</strong> en France, après une création nette de <strong>7 000 emplois</strong> en 2025, et prévoit environ <strong>20 000 recrutements</strong> supplémentaires en 2026.
            </p>
            <p className="text-justify-hyphens">
              Les ingénieurs et cadres techniques constituent une part majeure de ces recrutements : la filière aéronautique et spatiale est aujourd'hui le <strong>premier employeur d'ingénieurs en France</strong>, selon les données consolidées par IESF. Cette dynamique crée une demande massive de profils techniques rares, notamment en systèmes embarqués critiques et certification logicielle.
            </p>
          </div>
              ...
              {expertises.map((item, index) => {
                ...
                return (
                  <div key={index} className="aeronautique-expertise">
                    ...
                    <p className="aeronautique-expertise__text text-justify-hyphens">{item.text}</p>
                  </div>
                );
              })}
            </div>
          ...
          <div className="aeronautique-content__block">
            ...
            <p className="text-justify-hyphens">
              La <strong>DO-178C</strong> est la norme de certification logicielle avionique publiée par la FAA. Elle encadre la planification, le développement, la vérification et la certification des logiciels embarqués destinés à la sécurité des vols.
            </p>
            <p className="text-justify-hyphens">
            ...
            <p className="text-justify-hyphens">
              Au-delà de DO-178C, la norme <strong>ARP 4754A</strong> encadre le développement système (architecture, allocation des fonctions de sécurité), et <strong>DO-254</strong> s'applique aux composants électroniques programmables (FPGA, ASIC). L'ensemble forme une chaîne de certification que seules les autorités comme la <strong>FAA</strong> (Federal Aviation Administration) et l'<strong>AESA</strong> (Agence européenne de la sécurité aérienne) peuvent valider.
            </p>
            <p className="text-justify-hyphens">
          ...
          {/* POURQUOI LA CERTIFICATION STRUCTURE TOUT */}
          <div className="aeronautique-content__block">
            ...
            <ul className="aeronautique-list">
              <li><strong>LDRA</strong> pour la couverture de test et l'analyse statique</li>
              <li><strong>VectorCAST</strong> pour la gestion des tests unitaires</li>
              <li><strong>Polyspace</strong> pour l'analyse statique et la détection d'erreurs</li>
              <li><strong>Rational DOORS</strong> pour la gestion des exigences</li>
