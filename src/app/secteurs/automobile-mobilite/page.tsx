...
export const metadata = {
  title: "Automobile & Mobilité : conseil et ingénierie IT pour systèmes embarqués",
    ...
    <main className="automobile-page">
      ...
      <section className="automobile-content">
        <div className="automobile-content__inner">
          ...
          {/* UN SECTEUR EN MUTATION TECHNOLOGIQUE PROFONDE */}
          ...
          {/* UNE COMPLEXITÉ LOGICIELLE QUI EXIGE DES COMPÉTENCES RARES */}
          <div className="automobile-content__block">
            <h2 className="automobile-content__title">Une complexité logicielle qui exige des compétences rares</h2>
            <p className="text-justify-hyphens">
              Cette complexité crée une tension structurelle sur le marché des compétences. Les ingénieurs capables de maîtriser à la fois le <strong>C++ temps réel</strong>, les normes de sécurité fonctionnelle (<strong>ISO 26262</strong>, <strong>MISRA C/C++</strong>), et les architectures embarquées automobiles (<strong>Autosar</strong>) sont rares. La plupart des développeurs C++ généralistes n'ont pas de culture ISO 26262, et inversement.
            </p>
            <p className="text-justify-hyphens">
              La transition vers les véhicules électriques et connectés amplifie cette tension. De nouveaux domaines s'ajoutent aux compétences embarquées traditionnelles : les mises à jour logicielles OTA (Over-The-Air), la cybersécurité embarquée, et l'IA pour les systèmes ADAS. Un ingénieur automobile doit désormais raisonner dans plusieurs registres à la fois : déterminisme strict pour les systèmes critiques, richesse fonctionnelle pour les interfaces utilisateur, et sécurité face aux menaces cyber.
            </p>
            <p className="text-justify-hyphens">
              ...
              {expertises.map((item, index) => {
                ...
                return (
                  <div key={index} className="automobile-expertise">
                    ...
                    <p className="automobile-expertise__text text-justify-hyphens">{item.text}</p>
                  </div>
                );
              })}
            </div>
          ...
          <div className="automobile-content__block">
            ...
            <p className="text-justify-hyphens">
              <strong>SOTIF (ISO 21448)</strong> complète ISO 26262 en adressant les situations inattendues non couvertes par la sécurité fonctionnelle classique. Elle impose une analyse des scénarios d'utilisation anormaux et des défaillances du système face à des entrées inattendues. Pour les systèmes ADAS et autonomes, SOTIF est devenue incontournable.
            </p>
          </div>

          {/* SYSTÈMES EMBARQUÉS ET ISO 26262 */}
          <div className="automobile-content__block">
            <h2 className="automobile-content__title">Systèmes embarqués critiques et conformité ISO 26262</h2>
            <p className="text-justify-hyphens">
              <strong>ISO 26262</strong> est la norme internationale de sécurité fonctionnelle pour l'électronique automobile. Elle définit quatre niveaux de criticité - <strong>ASIL A à D</strong> (D = criticité maximale) - et impose un cadre de développement strict :
            </p>
          ...
          <div className="automobile-content__block">
            ...
            <p className="text-justify-hyphens">
              <strong>Autosar</strong> (AUTomotive Open System ARchitecture) est devenu le standard incontournable pour l'architecture logicielle embarquée automobile. Deux variantes coexistent :
            </p>
            <ul className="automobile-list">
          ...
          <div className="automobile-content__block">
            ...
            <p className="text-justify-hyphens">
              Les simulateurs de conduite reproduisent fidèlement la dynamique véhicule en temps réel, permettant la validation des algorithmes ADAS sans kilomètres réels. Les outils de référence - <strong>CARLA</strong>, <strong>IPG CarMaker</strong>, <strong>dSPACE ASM</strong> - offrent des environnements virtuels où les capteurs ADAS (LiDAR virtuel, caméra synthétique, radar) peuvent être testés dans des scénarios impossibles ou dangereux en conditions réelles.
            </p>
            <p className="text-justify-hyphens">
          ...
          <div className="automobile-content__block">
            ...
            <p className="text-justify-hyphens">
              Les systèmes d'info-divertissement (IVI) - cluster numérique, écran central, Head-Up Display, intégration Android Automotive / CarPlay - doivent concilier deux exigences paradoxales :
            </p>
            <ul className="automobile-list">
          ...
          <div className="automobile-content__block">
            ...
            <ul className="automobile-list">
              <li><strong>UN R155 :</strong> règlement ONU sur la cybersécurité automobile (gestion des risques cyber, architecture de sécurité)</li>
              <li><strong>UN R156 :</strong> gestion des mises à jour logicielles (OTA) avec intégrité et authentification</li>
            </ul>
            <p className="text-justify-hyphens">
